...
class bvh_node : public hittable {
  ...
  public:
    ...
    __device__ hittable* create_bvh_tree(hittable** objects, size_t start, size_t end){
      struct BVHWork {
        bvh_node* node;
        size_t start;
        size_t end;
...
__device__ static void sort_objects(hittable** objects, size_t start, size_t end, int axis){
    //insertionsrort
